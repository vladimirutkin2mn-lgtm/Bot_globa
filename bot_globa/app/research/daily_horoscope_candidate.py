...
_STORIES = MappingProxyType(
    {
        "инициатива": (
            ...
            "Сомнения тормозят старт — начните с простого.",
            "Инициатива заметна — заранее выберите цель.",
            "Новый импульс полезен — проверьте его делом.",
        ...
        "общение": (
            ...
            "Вас услышат лучше — говорите по существу.",
        ...
        "любовь и творчество": (
            ...
            "Творческая идея просится наружу — дайте ей форму.",
            "Лёгкость вернётся — оставьте место спонтанности.",
        ),
        "работа и режим": (
            "В работе проявится слабость — исправьте её сразу.",
            "Рабочая рутина утомляет — снимите лишнюю задачу.",
            "Порядок даст эффект — начните с самого срочного.",
            "Рабочий темп легко перегрузить — оставьте запас.",
        ),
        "отношения": (
            "В отношениях всплывёт вопрос — сначала выслушайте.",
            "Чужая реакция важна — не додумывайте мотивы.",
            "Честный разговор поможет — задайте прямой вопрос.",
            "Договориться проще — назовите, что для вас важно.",
            "Кто-то шагнёт навстречу — не отвечайте холодом.",
            "Граница требует ясности — обозначьте её спокойно.",
        ),
        "общие деньги": (
        ...
        "обучение и поездки": (
            ...
            "Полезный факт удивит — проверьте источник.",
        ...
        "карьера": (
            ...
            "Направление станет яснее — выберите один навык.",
            "На карьерной развилке сравните варианты — оцените отдачу.",
            "Ваш рабочий вклад заметят — не прячьте результат.",
            "Следующий карьерный шаг ясен — идите на отклик.",
        ),
        "друзья и планы": (
            "Друг даст новый угол — запишите идею.",
