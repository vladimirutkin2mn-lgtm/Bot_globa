...
DAILY_EDITORIAL_METHOD_VERSION = "solar-sign-daily-v7"
...
_STORIES = MappingProxyType(
    {
        ...
        "работа и режим": (
            ...
            "В работе легко перегрузиться — оставьте запас.",
        ),
        "отношения": (
        ...
        "обучение и поездки": (
            ...
            "В обучении всплывёт важный факт — проверьте источник.",
        ...
        "карьера": (
            ...
            "На работе ваш вклад заметят — не прячьте результат.",
...
def build_editorial_daily_horoscope(forecast_date: date) -> DailyHoroscopeSnapshot:
    """Build one v7 snapshot with compact situation-to-action human-facing forecasts."""
