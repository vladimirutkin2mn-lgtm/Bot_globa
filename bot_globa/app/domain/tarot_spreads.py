...
POSITION_FOCUS: dict[str, str] = {
    ...
    "decision_core": "в чём находится настоящая развилка выбора, а не только его внешняя формулировка",
    ...
    "pattern_hidden_need": "какая потребность или мотив может удерживать сценарий без клинических утверждений",
    ...
    "near_term_direction": "какой вектор может стать заметнее при сохранении текущих условий, без обещания будущего",
}
