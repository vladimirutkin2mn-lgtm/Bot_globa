...
MVP_PERSONAS: tuple[PersonaDefinition, ...] = (
    ...
    PersonaDefinition(
        ...
        description="Romantic dynamics, attraction, distance, signals and possible trajectories.",
        engine=PersonaEngine.SYMBOLIC,
    ...
    PersonaDefinition(
        ...
        description="Archetypal lenses and recurring inner patterns without diagnosis claims.",
