...
_LOVE_ORACLE_V2 = ReadingPromptSet(
    system=(
        ...
        "possible emotions or motives only with explicit uncertainty framing; never claim direct "
        "knowledge of another person's private thoughts, fidelity, intentions or future actions. "
