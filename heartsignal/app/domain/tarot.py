...
MAJOR_ARCANA_V1 = TarotCatalog(
    ...
    cards=(
        ...
        TarotCard("major_02", "Верховная Жрица", "интуиция и скрытое знание", "подавленная интуиция"),
        ...
        TarotCard("major_06", "Влюблённые", "выбор и согласование ценностей", "разрыв между желаниями"),
        ...
        TarotCard("major_11", "Справедливость", "последствия и честный баланс", "самообман и перекос"),
        ...
        TarotCard("major_15", "Дьявол", "привязанность и теневая мотивация", "освобождение от зависимости"),
        TarotCard("major_16", "Башня", "разрушение ложной опоры", "страх необходимого изменения"),
        TarotCard("major_17", "Звезда", "надежда и восстановление", "разочарование и потеря ориентиров"),
